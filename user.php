          ...
          <div class="carousel-item active">
            ...
            <div class="container">
              <div class="carousel-caption ccp ">
                ...
                <p><a class="btn btn-lg btn-primary" href="Menu User.php#chicken">See More</a></p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="carousel-caption ccp ">
                ...
                <p><a class="btn btn-lg btn-primary" href="Menu User.php#pork">See More</a></p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="carousel-caption ccp ">
                ...
                <p><a class="btn btn-lg btn-primary" href="Menu User.php#seafood">See More</a></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <center>
          ...
          <div class="row row-mn">
            <div class="col-lg-4">
              ...
              <p><a class="btn btn-secondary" href="Menu User.php">View details &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
              <h2>PORK</h2>
              <br>
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              ...
              <p>Less in fat and rich in flavour, free range chicken is cooked in the traditional Hainanese style and served with house- made chilli and ginger sauces. Taste less oil and more goodness in every bite.</p>
              <title>Placeholder</title>
              <p id="franchise"><a class="btn btn-secondary" href="Menu User.php">View details &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <hr class="featurette-divider">
