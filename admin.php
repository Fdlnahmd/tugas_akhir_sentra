          ...
          <div class="carousel-item active">
            ...
            <div class="container">
              <div class="carousel-caption ccp ">
                ...
                <p><a class="btn btn-lg btn-primary" href="Menu Admin.php#chicken">See More</a></p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="carousel-caption ccp ">
                ...
                <p><a class="btn btn-lg btn-primary" href="Menu Admin.php#pork">See More</a></p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="carousel-caption ccp ">
                ...
                <p><a class="btn btn-lg btn-primary" href="Menu Admin.php#seafood">See More</a></p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="collapse navbar-collapse" id="navbarsExample09">
              ...
              <div class="container ">
                <ul class="nav nav-fill text-uppercase justify-content-center">
                  <li class="nav-item dropdown"><a href="Menu Admin.php#chicken" class="nav-link "><br> Chicken</a></li>
                  <li class="nav-item dropdown"><a href="Menu Admin.php#pork" class="nav-link "><br> Pork</a></li>
                  <li class="nav-item dropdown"><a href="Menu Admin.php#omelette" class="nav-link ">Tofu <br> & Omelette</a></li>
                  <li class="nav-item dropdown"><a href="Menu Admin.php#fish" class="nav-link "><br> Fish</a></li>
                  <li class="nav-item dropdown"><a href="Menu Admin.php#seafood" class="nav-link "><br> Seafood</a></li>
                  <li class="nav-item dropdown"><a href="Menu Admin.php#vegetables" class="nav-link "><br> Vegetables</a></li>
                  <li class="nav-item dropdown"><a href="Menu Admin.php#srn" class="nav-link ">Soup,Rice, <br>& Noodles</a></li>
                  <li class="nav-item dropdown"><a href="Menu Admin.php#dnb" class="nav-link ">Desserts <br> & Beverages</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <center>
          ...
          <div class="row row-mn">
            <div class="col-lg-4">
              ...
              <p><a class="btn btn-secondary" href="Menu Admin.php#chicken">View details &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
              <h2>PORK</h2>
              <br>
              ...
              <p>Less in fat and rich in flavour, free range chicken is cooked in the traditional Hainanese style and served with house- made chilli and ginger sauces. Taste less oil and more goodness in every bite.</p>
              <title>Placeholder</title>
              <p><a class="btn btn-secondary" href="Menu Admin.php#pork">View details &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
              <h2>TOFU & OMELETTE</h2>
              <br>
              ...
              <p>Less in fat and rich in flavour, free range chicken is cooked in the traditional Hainanese style and served with house- made chilli and ginger sauces. Taste less oil and more goodness in every bite.</p>
              <title>Placeholder</title>
              <p><a class="btn btn-secondary" href="Menu Admin.php#omelette">View details &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
          </div><!-- /.row -->
          <!-- header 1 -->
          <hr class="featurette-divider">
          <div class="row">
            <div class="col-lg-4">
              ...
              <p>Less in fat and rich in flavour, free range chicken is cooked in the traditional Hainanese style and served with house- made chilli and ginger sauces. Taste less oil and more goodness in every bite.</p>
              <title>Placeholder</title>
              <p><a class="btn btn-secondary" href="Menu Admin.php#fish">View details &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
              <h2>SEAFOOD</h2>
              <br>
              ...
              <p>Less in fat and rich in flavour, free range chicken is cooked in the traditional Hainanese style and served with house- made chilli and ginger sauces. Taste less oil and more goodness in every bite.</p>
              <title>Placeholder</title>
              <p><a class="btn btn-secondary" href="Menu Admin.php#seafood">View details &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
              <h2>VEGETABLES</h2>
              <br>
              ...
              <p>Less in fat and rich in flavour, free range chicken is cooked in the traditional Hainanese style and served with house- made chilli and ginger sauces. Taste less oil and more goodness in every bite.</p>
              <title>Placeholder</title>
              <p><a class="btn btn-secondary" href="Menu Admin.php#vegetables">View details &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
          </div><!-- /.row -->
          <hr class="featurette-divider">
          <!-- header 2 -->
          <div class="row">
            <div class="col-lg-4">
              ...
              <p>Less in fat and rich in flavour, free range chicken is cooked in the traditional Hainanese style and served with house- made chilli and ginger sauces. Taste less oil and more goodness in every bite.</p>
              <title>Placeholder</title>
              <p><a class="btn btn-secondary" href="Menu Admin.php#srn">View details &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
              ...
              <p>Less in fat and rich in flavour, free range chicken is cooked in the traditional Hainanese style and served with house- made chilli and ginger sauces. Taste less oil and more goodness in every bite.</p>
              <title>Placeholder</title>
              <p id="franchise"><a class="btn btn-secondary" href="Menu Admin.php#dnb">View details &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <hr class="featurette-divider">
